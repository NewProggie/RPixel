...
#ifndef RPIXEL_CHECK_H
#define RPIXEL_CHECK_H
...
#ifndef NDEBUG
#define CHECK(b)                                                          \
    ((b) ? ::rpixel::base::internal::GetNullLoggingInstance()             \
         : ::rpixel::base::internal::CheckHandler(#b, __FILE__, __func__, \
                                                  __LINE__)               \
               .GetLog())
#else
#define CHECK(b) ::rpixel::base::internal::GetNullLoggingInstance()
#endif
